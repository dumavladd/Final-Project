...
SECRET_KEY = 'django-insecure-_^8h6wumasw+p!+-cow0$i09n1a^6zav-w9d-^*#+kir-x@8+k'
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/' # unde vrem ca u'lizatorul sa fie redirec'onat dupa auten'ficare (vom specifica prefixul)
